        ...
        <div className="min-h-screen bg-[#FAF7F2] py-20">
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
                        Frequently Asked Questions
                    </h1>
                    <p className="text-[#6B6B6B] max-w-2xl mx-auto">
                        Everything you need to know about our handcrafted cheese, shipping logistics, and the AGOC portal.
                    </p>
                </div>
                ...
                <div className="space-y-12">
                    {faqs.map((cat, catIdx) => (
                        <div key={catIdx}>
                            <h2 className="text-xl font-bold text-[#2C5530] mb-6 border-b border-[#2C5530]/10 pb-2 uppercase tracking-wider text-sm">
                                {cat.category}
                            </h2>
                                ...
                                {cat.questions.map((faq, faqIdx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                <span className="font-semibold text-[#1A1A1A] pr-8">{faq.q}</span>
                                                <svg
                ...
                <div className="mt-20 bg-[#2C5530] rounded-2xl p-8 md:p-12 text-center text-white shadow-xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-heading)' }}>Still have questions?</h3>
                        <p className="text-white/80 mb-8 max-w-lg mx-auto">
                            Our team is here to help you choose the perfect cheese or assist with your portal queries.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/wholesale" className="px-8 py-3 bg-[#C9A961] text-white rounded-full font-bold hover:scale-105 transition-transform shadow-lg">
                                Wholesale Inquiry
                            </Link>
                            <a href="mailto:technicalhead@achariya.org" className="px-8 py-3 bg-white/10 border border-white/20 text-white rounded-full font-bold hover:bg-white/20 transition-all">
