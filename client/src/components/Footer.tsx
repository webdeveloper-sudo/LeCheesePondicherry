  ...
  return (
    <footer className="bg-brand-green-subtle text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="flex justify-center md:justify-start gap-5 mt-8">
                {[
                  {
                    href: "https://www.facebook.com/profile.php?id=61582680524556#",
      ...
      <div className="border-t border-white/10 py-8 bg-black/10">
        <div className="container mx-auto px-6 md:px-8 flex flex-col md:flex-row justify-between items-center text-sm text-white/80">
