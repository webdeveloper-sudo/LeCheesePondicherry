    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <p className="text-[#C9A961] uppercase tracking-wider mb-4 font-medium">
                Our Story
              </p>
              <h2
                className="text-3xl md:text-4xl mb-6 text-white-prominent"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                Born from a Dream in Pondicherry
              </h2>
              <p className="text-white/90 mb-6 leading-relaxed">
                Le Pondicherry Cheese was founded with a simple vision: to bring
                the art of French cheesemaking to the sun-kissed shores of
                Pondicherry. Our journey began when we discovered that the
                perfect cheese could only be made with patience, passion, and
                the finest ingredients.
              </p>
              <p className="text-white/90 mb-8 leading-relaxed">
                Today, our master cheesemakers combine time-honored European
                techniques with local ingredients to create cheeses that are
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-[#6B6B6B]">
                Techniques passed down through generations, perfected in
                Pondicherry
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#FAF7F2]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2
              className="text-4xl font-bold mb-4 text-[#1A1A1A]"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Never Run Out of Cheese
            </h2>
            <p className="text-[#6B6B6B] max-w-2xl mx-auto">
              Subscribe to our Monthly Cheese Club and receive 3-4 artisan
              cheeses delivered fresh to your door. Save 15% on every order and
              discover new flavors each month.
            </p>
          </div>
              ...
              >
                ...
                <div className="flex gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <svg
                      key={i}
                      className="w-5 h-5 text-[#C9A961] fill-current"
                      viewBox="0 0 20 20"
                    >
      ...
      <section className="p-2">
        <div className=" mx-auto px-2">
          <div className="bg-gradient-to-r from-[#2C5530] to-[#3D7343] rounded-2xl p-8 md:p-12 text-white text-center">
            <h2
              className="text-3xl md:text-4xl mb-4 text-white-prominent"
              style={{ fontFamily: "var(--font-heading)" }}
            >
            ...
            <Link
              to="/gifts"
              className="btn btn-primary bg-[#C9A961] hover:bg-[#B8942F]"
            >
