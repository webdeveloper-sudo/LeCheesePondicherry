  ...
  useEffect(() => {
    if (existingBlog) {
      setFormData({
        ...
        onHold: existingBlog.onHold ?? false,
      });
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="p-6 bg-red-50 rounded-xl border border-red-100 flex items-center justify-between mb-8">
            <div>
              <h3 className="text-sm font-bold text-red-700 uppercase tracking-wider">Hold Management</h3>
              <p className="text-xs text-red-600 mt-1">When on hold, this blog will be hidden from the public Stories page.</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <span className="ml-3 text-sm font-bold text-red-700 uppercase">On Hold</span>
            </label>
          </div>
