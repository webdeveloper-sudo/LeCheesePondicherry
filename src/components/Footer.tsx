                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm text-white/90">
                                <li><Link href="/shop" className="hover:text-[#C9A961] transition-colors">All Cheeses</Link></li>
                                <li><Link href="/shop?category=aged" className="hover:text-[#C9A961] transition-colors">Aged Cheeses</Link></li>
                                <li><Link href="/shop?category=soft" className="hover:text-[#C9A961] transition-colors">Soft Cheeses</Link></li>
                                <li><Link href="/gifts" className="hover:text-[#C9A961] transition-colors">Gift Collections</Link></li>
                                <li><Link href="/shop?category=subscription" className="hover:text-[#C9A961] transition-colors">Subscription Boxes</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm text-white/90">
                                <li><Link href="/about" className="hover:text-[#C9A961] transition-colors">Our Story</Link></li>
                                <li><Link href="/process" className="hover:text-[#C9A961] transition-colors">Artisan Process</Link></li>
                                <li><Link href="/faq" className="hover:text-[#C9A961] transition-colors">FAQ</Link></li>
                                <li><Link href="/contact" className="hover:text-[#C9A961] transition-colors">Visit Us</Link></li>
                                <li><Link href="/wholesale" className="hover:text-[#C9A961] transition-colors">Wholesale</Link></li>
                            </ul>
                        </div>
            ...
            <div className="border-t border-white/10 py-8">
                <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-sm text-white/90">
                    ...
                    <div className="flex gap-6 mt-4 md:mt-0 font-medium">
                        <Link href="/shipping" className="hover:text-[#C9A961] transition-colors">Shipping & Returns</Link>
