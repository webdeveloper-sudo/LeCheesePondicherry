    ...
    const stories = [
        {
            ...
            excerpt: 'Deep within our temperature-controlled caves in Pondicherry, thousands of cheese wheels are quietly transforming...',
            date: 'May 12, 2024',
        ...
        },
        {
            ...
            excerpt: 'How our master cheesemakers blended centuries-old European techniques with the unique flavors of local Indian dairy...',
            date: 'April 28, 2024',
        ...
        },
        {
            ...
            excerpt: 'Discover why our signature sharp cheddar is the perfect companion for locally crafted kombuchas and fruit infusions...',
            date: 'April 15, 2024',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {stories.map((story, i) => (
                            <div key={i} className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 group">
                                ...
                                <div className="p-6">
                                    <p className="text-[#C9A961] text-xs font-bold uppercase tracking-wider mb-2">{story.date}</p>
                                    <h3 className="text-xl font-bold mb-3 group-hover:text-[#2C5530] transition-colors" style={{ fontFamily: 'var(--font-heading)' }}>
                                        {story.title}
                                    </h3>
                                    <p className="text-[#6B6B6B] text-sm mb-4 leading-relaxed">
                                        {story.excerpt}
                                    </p>
                                    <Link href={`/stories/${story.id}`} className="text-sm font-bold text-[#2C5530] hover:underline">
                                        Read Story →
                                    </Link>
                                </div>
                            </div>
