...
export default function StoryDetail() {
    ...
    const story = stories[slug as keyof typeof stories] || stories['art-of-aging'];

    return (
        <div className="min-h-screen bg-[#FAF7F2]">
            <section className="py-20">
                <div className="container mx-auto px-4 max-w-3xl">
                    <Link href="/stories" className="text-[#2C5530] font-bold mb-8 inline-block hover:underline">
                        ← Back to Journal
                    </Link>
                    <Image
                        src={story.image}
