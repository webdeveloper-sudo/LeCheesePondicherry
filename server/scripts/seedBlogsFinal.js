...
const migrateImage = async (relativePath) => {
  ...
  try {
    // Handle the "@/assets/images/" prefix if present
...
const blogsData = [
  {
    ...
    category: "Tradition",
    imagePath: "products/aged-cheddar.jpg",
    ...
    galleryPaths: [
      "products/aged-cheddar.jpg",
      "products/classic-brie.jpg",
      "products/kombucha-rind.jpg",
      "products/baby-swiss-texture.png",
      "products/daddy-swiss-texture.png",
      "products/grana-chery-texture.png",
    ],
    quote: {
...
True cheese is more than an ingredient — it is an experience shaped by time, tradition, and care. And every slice of **Le Pondicherry Cheese** carries the story of responsible farming, patient craftsmanship, and a passion for dairy excellence.`,
  ...
  },
  {
    ...
    excerpt: "Over the past decade, India's culinary landscape has undergone a remarkable transformation. Consumers are no longer satisfied with generic processed cheese — they are discovering the world of artisanal cheese...",
...
Great cheese reflects the harmony between **nature, science, and time**. As consumers continue to value authenticity and flavour, artisanal cheeses will play an increasingly important role in India's evolving culinary story.`,
  ...
  },
  {
    ...
    author: "Admin",
    category: "Tradition",
    imagePath: "products/baby-swiss-texture.png",
    excerpt: "In the world of fine cheese, time is more than a process — it is an ingredient. While fresh cheeses delight with their milky softness, aged cheeses reveal deeper character and complex flavour profiles that only patience can create...",
...
Cheese ageing is a beautiful reminder that some of the finest things in life require patience. With time, care, and craftsmanship, simple milk evolves into something remarkable — rich in flavour, texture, and tradition.`,
  ...
  },
  {
    ...
    author: "Admin",
    category: "Lifestyle",
    imagePath: "products/daddy-swiss-texture.png",
    excerpt: "Cheese is one of the most versatile ingredients in the culinary world. For chefs and culinary professionals, understanding different cheese types is essential for building balanced menus and creating memorable dishes...",
...
Understanding different varieties allows culinary professionals to choose the perfect cheese for every dish.`,
  ...
  },
  {
    ...
    excerpt: "Few ingredients define pizza as much as cheese. The right cheese determines how the pizza melts, stretches, browns, and tastes. Two popular choices are fresh mozzarella and low-moisture mozzarella — but which one works best?",
...
Understanding how different cheeses behave during baking helps chefs achieve the ideal texture, flavour, and presentation every time.`,
  ...
  },
  {
    ...
    author: "Admin",
    category: "Lifestyle",
    imagePath: "products/grana-chery-texture.png",
    excerpt: "A beautifully arranged cheese board can turn a casual gathering into a memorable dining experience. The secret lies in balance, variety, and presentation...",
...
const seedBlogs = async () => {
  try {
    ...
    console.log(`📝 Seeding ${blogsData.length} blogs...`);
    ...
    for (const b of blogsData) {
      ...
      const imageUrls = [];
      if (b.galleryPaths) {
        for (const imgPath of b.galleryPaths) {
          const url = await migrateImage(imgPath);
          if (url) imageUrls.push(url);
        }
      }

      const mainImageUrl = await migrateImage(b.imagePath);
      ...
      delete finalBlog.imagePath;
      delete finalBlog.galleryPaths;

      await Blog.create(finalBlog);
      console.log(`✅ ${b.title} seeded successfully.`);
    }
